...
class FactaGovPrSeguro extends Component {
  ...
  constructor(props) {
    ...
    if (this.props.location.state === undefined) {
      ...
      var PRINCIPAL = _state.obj_pendencias !== undefined && _state.obj_pendencias.length !== 0 ? _state.obj_pendencias : _state.obj_proposta;
      ...
      if (PRINCIPAL.DADOSTABELA !== undefined && PRINCIPAL.DADOSTABELA.length !== 0 && PRINCIPAL.DADOSTABELA.length !== 0) {
...
export default FactaGovPrSeguro;
