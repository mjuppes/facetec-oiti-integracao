                      ...
                      <CardBody>
                        ...
                        <Row>
                              {(this.props.etapaFinalizar === false  && this.props.isAnalfabetoEnvDoc === false) &&
                                <Col className="text-center" md="12" lg="12" xl="12" xs="12" sm="12">
                                    <Button className="btn btn-outline-primary btn-block btn-lg font-weight-bold mt-2" color="outline-danger" onClick={() => this.removeDoc()}><i className="fa fa-trash"></i> Remover</Button>
